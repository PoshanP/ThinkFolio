...
import { DEFAULT_COLLECTION_COLOR, DEFAULT_COLLECTION_ICON, STYLE_CLASSES } from "@/lib/constants";
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="flex items-center justify-end gap-3 pt-4 border-t border-gray-200 dark:border-gray-700">
            ...
            <button
              ...
              className={`flex items-center gap-2 px-4 py-2 text-sm font-medium text-white ${STYLE_CLASSES.buttonPrimary} disabled:opacity-50 disabled:cursor-not-allowed rounded-lg`}
            >
              {saving ? (
